...
// calendar date beyond ("Sep 18"). Anchored to the fetch, like everything
// else — so early on release day, before that morning's fetch, a card can
// still read "Tomorrow"; the header's "Updated Xh ago" carries the staleness.
